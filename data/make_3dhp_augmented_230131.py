...
tot_frames = 1.344e6 / 2 #3.36e6
frames_per_seq = 1 #1000
        ...
        for z_trans in z_trans_candi:
            for phi_rot in gp_phi_rot_candi:
                for p_trans in person_trans_candi:
                    p_trans_ub = p_trans * 6000
                    p_trans_lb = p_trans * -6000
                    ...
                    np.savez_compressed(f'data/data_3d_vid3dhp_{augtype}_img_1_3M_230215.npz', positions_3d=dataset_3d)
                    np.savez_compressed(f'data/data_2d_vid3dhp_{augtype}_img_1_3M_230215.npz', positions_2d=dataset_2d, vis=dataset_vis, obj=dataset_obj, img_path=dataset_img_path)
